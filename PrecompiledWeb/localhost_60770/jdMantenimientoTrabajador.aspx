<%@ page title="Consulta de Trabajadores" language="VB" masterpagefile="~/MasterPage.master" autoeventwireup="false" inherits="jdMantenimientoTrabajador, App_Web_0fjqdpnu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-grid">
        ...
        <div class="panel-box">
            ...
            <div class="fila-buscar">
                <span class="lbl-buscar">Buscar por nombre:</span>
                ...
                <asp:GridView ID="dgvTrabajador" runat="server" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Estado">
                            <ItemTemplate>
                                <span class='<%# IIf(Convert.ToBoolean(Eval("Activo")), "estado-activo", "estado-debaja") %>'>
                                    <%# IIf(Convert.ToBoolean(Eval("Activo")), "Activo", "De baja") %>
                                </span>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <asp:Label ID="lblMensaje" runat="server" CssClass="mensaje-info" Text=""></asp:Label>
    ...
    <!-- Confirmación de baja en cliente si es posible, de lo contrario lo hace en servidor -->
