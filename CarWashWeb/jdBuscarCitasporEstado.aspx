<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="jdBuscarCitasporEstado.aspx.vb" Inherits="jdBuscarCitasporEstado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="titulo-modulo">
        <h1>BUSCAR CITAS</h1>
        <p>Busque las citas ingresadas mediante el estado en el que se encuentran</p>
    </div>
    ...
    <div class="panel-grid una-columna">
        ...
        <div class="panel-box">
            ...
            <div class="fila-buscar">
                <asp:DropDownList ID="ddlSexo" runat="server" CssClass="form-control" placeholder="Seleccionar el estado...">
            ...
            <div class="contenedor-tabla-scroll">
                <asp:GridView ID="dgvGestion" runat="server" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="comentario" HeaderText="Servicio que se hizo" />
                        <asp:BoundField DataField="fechaRecojo" HeaderText="Fecha de Recojo programada" />
                        <asp:BoundField DataField="idVehiculo" HeaderText="Id del vehículo" />
                        <asp:BoundField DataField="idTrabajador" HeaderText="Id del trabajador" />
                    </Columns>
                    <EmptyDataTemplate>
                        <div style="padding: 20px; text-align: center; color: #6B7280;">No se encontraron mantenimientos.</div>
                    </EmptyDataTemplate>
                </asp:GridView>
            </div>
