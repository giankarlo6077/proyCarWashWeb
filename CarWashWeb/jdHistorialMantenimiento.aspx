<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="jdHistorialMantenimiento.aspx.vb" Inherits="jdHistorialMantenimiento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="titulo-modulo">
        ...
        <p>Consulta los mantenimientos del cliente ingresando su N° de documento</p>
    </div>
    ...
    <div class="panel-grid una-columna">
        ...
        <div class="panel-box">
            ...
            <div class="fila-buscar">
                <asp:TextBox ID="txtbuscador" runat="server" CssClass="form-control" placeholder="Buscar por nro de documento..."></asp:TextBox>
            ...
            <div class="contenedor-tabla-scroll">
                <asp:GridView ID="dgvMantenimientos" runat="server" AutoGenerateColumns="false"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="persona" HeaderText="Nombre del Cliente" />
                        <asp:BoundField DataField="numDocumento" HeaderText="Documento" />
                        <asp:BoundField DataField="placa" HeaderText="Placa de auto" />
                        <asp:BoundField DataField="fecha" HeaderText="Fecha de ingreso" />
                        <asp:BoundField DataField="hora" HeaderText="Hora de ingreso" />
                        <asp:BoundField DataField="estado" HeaderText="Estado del Servicio" />
                        <asp:BoundField DataField="fechaRecojo" HeaderText="Fecha de Recojo programada" />
                        <asp:BoundField DataField="Servicio" HeaderText="Servicio que se hizo" />
                        <asp:BoundField DataField="producto" HeaderText="Productos que se usaron" />
                        <asp:BoundField DataField="trabajador" HeaderText="Trabajador a cargo" />
                        <asp:BoundField DataField="precioVenta" HeaderText="Precio" DataFormatString="{0:N2}" />
                    </Columns>
                    <EmptyDataTemplate>
                        <div style="padding: 20px; text-align: center; color: #6B7280;">No se encontraron mantenimientos. Revisar los datos ingresados.</div>
                    </EmptyDataTemplate>
                </asp:GridView>
            </div>
