<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="jdPapeleraProducto.aspx.vb" Inherits="jdPapeleraProducto" %>
    ...
    <div class="panel-grid una-columna">
        ...
        <div class="panel-box">
            ...
            <div class="fila-buscar">
                <asp:TextBox ID="txtId" runat="server" CssClass="form-control" ReadOnly="true" placeholder="ID del producto seleccionado..."></asp:TextBox>
                <asp:Button ID="btnRecuperar" runat="server" Text="♻️ Recuperar" CssClass="btn-accion btn-recuperar" CausesValidation="false" />
                <asp:Button ID="btnEliminar" runat="server" Text="🗑️ Eliminar definitivo" CssClass="btn-accion btn-eliminar" CausesValidation="false"
            ...
            <div class="contenedor-tabla-scroll">
                <asp:GridView ID="dgvPapelera" runat="server" AutoGenerateColumns="false"
