...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-grid">
        ...
        <!-- Formulario -->
        <div class="panel-box">
            <h3>Datos del Tipo de Producto</h3>

            <div class="campo-form">
                <label>ID Tipo de Producto:</label>
                <asp:TextBox ID="txtIdTipoProducto" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
        ...
        <div class="panel-box">
            ...
            <div class="contenedor-tabla-scroll">
                <asp:GridView ID="dgvTipos" runat="server" AutoGenerateColumns="false"
                        ...
                        <asp:TemplateField HeaderText="Acción">
                            <ItemTemplate>
                                <asp:Button ID="btnSeleccionar" runat="server" Text="Seleccionar" CssClass="btn-seleccionar"
                                    CommandName="Seleccionar" CommandArgument='<%# Eval("idtipoproducto") %>' CausesValidation="false" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                    <EmptyDataTemplate>
