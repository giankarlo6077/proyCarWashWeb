<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="jdGestionarProducto.aspx.vb" Inherits="jdGestionarProducto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        /* Barra superior: buscador en vivo + Registrar Nuevo */
        ...
        /* Iconos de la columna Acción: tamaño fijo y sin salto de línea (evita que se apilen) */
        ...
        .btn-icono.baja { background-color: #D97706; } .btn-icono.baja:hover { background-color: #B45309; }
        ...
        .modal-card { background: #fff; border-radius: 8px; padding: 26px; width: 480px; max-width: 92%; max-height: 90vh; overflow-y: auto; box-shadow: 0 10px 40px rgba(0,0,0,.3); }
    ...
    <script type="text/javascript">
        // Búsqueda en vivo: filtra las filas del grid conforme se escribe
        function filtrarProductos() {
            var filtro = document.getElementById('txtFiltro').value.toLowerCase();
            var tabla = document.getElementById('dgvProductos');
            if (!tabla) return;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="barra-volver">
        <button type="button" class="btn-volver" onclick="window.location.href='jdMantenimientoProducto.aspx'; return false;">⬅️ Volver</button>
    </div>

    <div class="titulo-modulo">
        <h1>GESTIÓN DE PRODUCTOS</h1>
        <p>Registra, edita, da de baja y administra el inventario de productos</p>
    </div>

    <div class="panel-box">

        <!-- Buscador en vivo + Registrar Nuevo -->
        <div class="toolbar">
            <input type="text" id="txtFiltro" class="form-control" placeholder="🔍 Buscar producto por id, nombre, tipo o marca..." onkeyup="filtrarProductos();" />
        ...
        <div class="contenedor-tabla-scroll">
            <asp:GridView ID="dgvProductos" runat="server" AutoGenerateColumns="false" ClientIDMode="Static"
                CssClass="grid-modulo" GridLines="None" Width="100%"
                DataKeyNames="idproducto" OnRowCommand="dgvProductos_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Acción">
                        ...
                        <ItemTemplate>
                            <asp:Button ID="btnEditar" runat="server" Text="✏️" ToolTip="Modificar" CssClass="btn-icono editar"
                                CommandName="Editar" CommandArgument='<%# Eval("idproducto") %>' CausesValidation="false" />
                            <asp:Button ID="btnBaja" runat="server" Text="⬇️" ToolTip="Dar de baja" CssClass="btn-icono baja"
                                CommandName="Baja" CommandArgument='<%# Eval("idproducto") %>' CausesValidation="false"
                                OnClientClick="return confirm('¿Dar de baja este producto?');" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <EmptyDataTemplate>
        ...
        <div class="enlaces-modulo">
            <a class="btn-enlace" href="jdGestionarTipoProducto.aspx">🏷️ Tipo de Producto</a>
            <a class="btn-enlace" href="jdGestionarMarca.aspx">🔖 Marca</a>
            <a class="btn-enlace" href="jdPapeleraProducto.aspx">🗑️ Papelera</a>
        </div>

        <asp:Label ID="lblMensaje" runat="server" Text=""></asp:Label>
    </div>

    <!-- ===== Modal del formulario (Registrar / Modificar) ===== -->
    <asp:Panel ID="pnlForm" runat="server" CssClass="modal-overlay" Visible="false">
        <div class="modal-card">
            <h3><asp:Label ID="lblFormTitulo" runat="server" Text="Registrar Producto"></asp:Label></h3>
            ...
            <div class="campo-form">
                ...
                <asp:DropDownList ID="cboTipoProducto" runat="server" CssClass="form-control"></asp:DropDownList>
            </div>

            <div class="campo-form">
                <label>Marca:</label>
                <asp:DropDownList ID="cboMarcaProducto" runat="server" CssClass="form-control"></asp:DropDownList>
            </div>

            <div class="campo-checkbox">
                <asp:CheckBox ID="chkVigencia" runat="server" Checked="true" />
                <label>Vigencia (producto activo)</label>
            </div>
