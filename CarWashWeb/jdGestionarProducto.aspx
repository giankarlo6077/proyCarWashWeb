...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-grid">
        ...
        <div class="panel-box">
            ...
            <div class="botonera">
                <asp:Button ID="btnNuevo" runat="server" Text="➕ Nuevo" CssClass="btn-accion btn-nuevo" CausesValidation="false" />
                <asp:Button ID="btnBuscar" runat="server" Text="🔍 Buscar" CssClass="btn-accion btn-buscar-2" CausesValidation="false" />
                <asp:Button ID="btnModificar" runat="server" Text="✏️ Modificar" CssClass="btn-accion btn-modificar" CausesValidation="false" />
                <asp:Button ID="btnLimpiar" runat="server" Text="🧹 Limpiar" CssClass="btn-accion btn-limpiar" CausesValidation="false" />
                <asp:Button ID="btnDarsebaja" runat="server" Text="⬇️ Dar de baja" CssClass="btn-accion btn-eliminar" CausesValidation="false" />
            </div>
                        ...
                        <asp:TemplateField HeaderText="Acción">
                            <ItemTemplate>
                                <asp:Button ID="btnSeleccionar" runat="server" Text="Seleccionar" CssClass="btn-seleccionar"
                                    CommandName="Seleccionar" CommandArgument='<%# Eval("idproducto") %>' CausesValidation="false" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                    <EmptyDataTemplate>
