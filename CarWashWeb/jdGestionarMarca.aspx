<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="jdGestionarMarca.aspx.vb" Inherits="jdGestionarMarca" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="titulo-modulo">
        ...
        <p>Registra, edita y elimina las marcas de los productos</p>
    </div>
    ...
    <div class="panel-grid">
        ...
        <div class="panel-box">
            ...
            <div class="botonera">
                ...
                <asp:Button ID="btnEliminar" runat="server" Text="🗑️ Eliminar" CssClass="btn-accion btn-eliminar" CausesValidation="false" />
            </div>
        ...
        <div class="panel-box">
            ...
            <div class="contenedor-tabla-scroll">
                <asp:GridView ID="dgvMarcas" runat="server" AutoGenerateColumns="false"
                    ...
                    DataKeyNames="idmarcaproducto" OnRowCommand="dgvMarcas_RowCommand">
                    <Columns>
                        <asp:BoundField DataField="idmarcaproducto" HeaderText="ID" />
                        <asp:BoundField DataField="marcaproducto" HeaderText="Nombre" />
                        <asp:TemplateField HeaderText="Acción">
                            <ItemTemplate>
                                <asp:Button ID="btnSeleccionar" runat="server" Text="Seleccionar" CssClass="btn-seleccionar"
                                    CommandName="Seleccionar" CommandArgument='<%# Eval("idmarcaproducto") %>' CausesValidation="false" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                    <EmptyDataTemplate>
                        <div style="padding: 20px; text-align: center; color: #6B7280;">No se encontraron marcas.</div>
                    </EmptyDataTemplate>
                </asp:GridView>
            </div>
        </div>
