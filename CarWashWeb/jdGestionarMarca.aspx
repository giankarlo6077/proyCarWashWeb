...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel-box">
        ...
        <div class="toolbar">
            <input type="text" id="txtFiltro" class="form-control" placeholder="🔍 Buscar marca por id o nombre..." onkeyup="filtrarTabla('txtFiltro','dgvMarcas');" />
        ...
        <div class="contenedor-tabla-scroll">
            <asp:GridView ID="dgvMarcas" runat="server" AutoGenerateColumns="false" ClientIDMode="Static"
                    ...
                    <asp:TemplateField HeaderText="Acción">
                        ...
                        <ItemTemplate>
                            <asp:Button ID="btnEditar" runat="server" Text="✏️" ToolTip="Modificar" CssClass="btn-icono editar"
                                CommandName="Editar" CommandArgument='<%# Eval("idmarcaproducto") %>' CausesValidation="false" />
                            <asp:Button ID="btnEliminar" runat="server" Text="🗑️" ToolTip="Eliminar" CssClass="btn-icono eliminar"
                                CommandName="Quitar" CommandArgument='<%# Eval("idmarcaproducto") %>' CausesValidation="false"
    ...
    <asp:Panel ID="pnlForm" runat="server" CssClass="modal-overlay" Visible="false">
        <div class="modal-card">
            <h3><asp:Label ID="lblFormTitulo" runat="server" Text="Registrar Marca"></asp:Label></h3>
